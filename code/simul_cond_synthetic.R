...
ntest <- 10000
set.seed(seed * 2020)
filename <- paste0("../data/simul_cond_n", n, "_d", d,
                   "_seed", seed,
                   ".RData")
res <- list()
...
res[[1]] <- Cf_expr_cond(n, d, ntest, Xfun, taufun, sdfun, psfun, errdist, types = "tau")
...
res[[2]] <- Cf_expr_cond(n, d, ntest, Xfun, taufun, sdfun, psfun, errdist, types = c("tau", "std"))
...
res[[3]] <- Cf_expr_cond(n, d, ntest, Xfun, taufun, sdfun, psfun, errdist, types = "tau")
...
res[[4]] <- Cf_expr_cond(n, d, ntest, Xfun, taufun, sdfun, psfun, errdist, types = c("tau", "std"))
